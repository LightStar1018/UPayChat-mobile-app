          ...
          Container(
            ...
            child: Container(
              ...
              child: TextButton(
                ...
                // shape: basicGreenButtonShape(),
                style: ButtonStyle(
                    backgroundColor: MaterialStateProperty.all<Color>(MyColors.base_green_color),
                    shape: MaterialStateProperty.all<OutlinedBorder>(basicGreenButtonShape()),
                    padding: MaterialStateProperty.all<EdgeInsets>(EdgeInsets.fromLTRB(60, 15, 60, 15))),
                onPressed: () {
                  Navigator.pop(context);
                },
                child: Text(

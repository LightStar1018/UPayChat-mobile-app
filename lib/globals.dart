class Globals {
  static const int APP_SERVER =
      2; //0: local server, 1: dev server, 2: live server
  static const bool DEBUGGING = false;
  static bool isInForeground = true;
  static DateTime? typingDate = DateTime.now();
  static int unreadMsgCount = 0;
  static int unreadPending = 0;
  static double walletbalance = 0;
  static bool isOnline = true;
  static List<String> result = new List.empty();
  ...
  static const String local_server = 'https://192.168.107.160:8000';
  static const String dev_server = 'https://dev.upaychat.com';
  static const String live_server = 'https://admin.upaychat.com';
  ...
  static bool notification_push_money_received = true;
  static bool notification_push_money_sent = true;
  static bool notification_push_bank_withdraw= true;
  static bool notification_push_likes= true;
  static bool notification_push_comments= true;
  static bool notification_sms_money_received= true;
  static bool notification_sms_money_sent= true;
  static bool notification_email_money_received= true;
  static bool notification_email_money_sent= true;
  static bool notification_email_bank_withdraw= true;
}

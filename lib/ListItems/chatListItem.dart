...
class ChatList extends State<ChatListItem> {
  ...
  void initState() {
    ...
    String? tmpChild1 =
        widget.isCustomer! ? userid : widget.data?.user_id?.toString();
    String? tmpChild2 =
        !widget.isCustomer! ? userid : widget.data?.user_id?.toString();
    try {
    ...
    updateListener =
        FirebaseUtils.onValueListener(tmpChild1, tmpChild2).listen((event) {
      updateValue(event);
    });
    super.initState();
  }
  ...
  void updateValue(event) {
    ...
    if (event.snapshot.exists) {
      ...
      checkRead(Map tmpMap) {
        return tmpMap.containsKey('sender') &&
            tmpMap['sender'] != userid &&
            !tmpMap['read'];
      }
      ...
      if (msgData != null) {
        text = (msgData.containsKey("text") && msgData['text'] != null)
            ? msgData['text']
            : "";
        read = (msgData.containsKey("read") && msgData['read'] != null) &&
            msgData['read'];
        sent = read ||
            (msgData.containsKey("sent") &&
                msgData['sent'] != null &&
                msgData['sent']);
      }
    }
    MessageModel tmpLast =
        new MessageModel(id, text, read, sent, unread, sender);
    setState(() {
      lastMessage = tmpLast;
    });
  }

  void closeChat(BuildContext context, dynamic param) {
    showDialog(
      context: context,
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              FirebaseUtils.deleteMessage(
                  widget.isCustomer! ? userid : selUsrId,
                  widget.isCustomer! ? selUsrId : userid);
              Navigator.of(context).pop(false);
            },
            child: Text(
              'Yes',
  ...
  Widget build(BuildContext context) {
    ...
    bool isNotEmptyMsg = lastMessage != null &&
        lastMessage!.id != null &&
        lastMessage!.id.isNotEmpty;
    return Slidable(
      ...
      endActionPane: ActionPane(
        ...
        children: [
          SlidableAction(
            ...
            flex: 2,
            onPressed: (context) => closeChat(context, item),
                ...
                child: Row(
                  children: [
                    Container(
                        ...
                        child: CircleAvatar(
                          radius: 100,
                          backgroundImage: this._loadImageError != null &&
                                  this._loadImageError!
                              ? null
                              : NetworkImage(
                                  Globals.base_url + item.profile_image),
                          ...
                          child: this._loadImageError != null &&
                                  this._loadImageError!
                              ? Text(
                    ...
                    Container(
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              isNotEmptyMsg && lastMessage != null
                                  ? Icon(
                                      Icons.check,
                              ...
                              isNotEmptyMsg && lastMessage != null
                                  ...
                                  : Container(),
                              Container(
                                child: Text(isNotEmptyMsg && lastMessage != null
